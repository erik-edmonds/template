...
def Header(name, app):
    ...
    logo = html.Img(
        src=app.get_asset_url("botler.png"), style={"float": "right", "height": 60}
    )
    link = html.A(logo, href="https://erikedmonds.com")
...
app.title = "Botler: Sensor Fusion"
server = app.server
...
info_collapse = dbc.Collapse(
    [
        ...
        dbc.Card(
            dcc.Markdown(
                dedent(
                    """TODO: Add details about Botler. Not even sure what it is.
            """
                )
            ),
            body=True,
...
app.layout = dbc.Container(
    [
        Header("Botler: Sensor Fusion", app),
        html.Hr(),
        dbc.Row(
            [
                dbc.Col(
